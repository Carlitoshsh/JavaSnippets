...
public class ProgramaPrincipal {
    public static void main(String[] args) {
        ...
        Perro[] perros = new Perro[] {
            new Perro(null, "cian", 6, false),
            new Perro("Sol"),
            new Perro("Ayudante de Santa", "cafe"),
            new Perro("Sol", "rojo", 0, true),
            new Perro("Sacha", "azul", 5, false),
            new Perro("Tony", "blanco", 4, true)
        };
        ...
        for (Perro perro : perros) {
            ...
            if(perro.estado > 3) {
                ...
                " es mas urgente de atencion, Estado: " +
                perro.estado);
            } else {
                System.out.println(perro.nombre + 
                " esta en buen estado, Estado: " +
                perro.estado);
            }
        }
